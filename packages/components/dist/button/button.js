 ...
 */
let FkButton = class FkButton extends LitElement {
    static styles = css `
    :host {
  ...
  `;
    ...
    _handleClick(event) {
        ...
        this.dispatchEvent(new CustomEvent('fk-click', {
...
], FkButton.prototype, "variant", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], FkButton.prototype, "size", void 0);
__decorate([
    property({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], FkButton.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], FkButton.prototype, "loading", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], FkButton.prototype, "type", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], FkButton.prototype, "href", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], FkButton.prototype, "target", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], FkButton.prototype, "rel", void 0);
FkButton = __decorate([
